    ...
    const sendGetRequest = async () => {
        try {
            ...
            if (resp.data.aprobado_por=='2') {
                ...
                $('#text-ribbon').addClass("ribbon-success").removeClass("ribbon-info").removeClass('ribbon-secondary').removeClass("ribbon-danger");
                ...
                $('#text-ribbon').removeClass("ribbon-success").removeClass("ribbon-danger").removeClass('ribbon-secondary').addClass("ribbon-info");
            }else if(resp.data.estatus_cot=='1'){
                $('#text-ribbon').show();
                $('#new-estructura').hide();
                $('#generado-estructura').show();
                $('#text-ribbon').text("Estructura generada");
                $('#text-ribbon').removeClass("ribbon-success").removeClass("ribbon-danger").removeClass("ribbon-info").addClass('ribbon-secondary');
            }else if(resp.data.estatus_cot=='2') {
                $('#text-ribbon').show();
                $('#text-ribbon').text("Esta estructura está anulado");
                $('#new-estructura').hide();
                $('#generado-estructura').show();
                $('#text-ribbon').removeClass("ribbon-info").removeClass('ribbon-secondary').removeClass("ribbon-success").addClass("ribbon-danger");
            }
            // $('#text-ribbon').hide();
    ...
    const sendGetRequest = async () => {
        try {
           ...
           for (let i = 0; i < resp.data.length; i++) {
                ...
                cadena +='<div class="col-6 col-md-6">';
                // cadena += '<h6 class="m-0 font-14">APU Nº '+resp.data[i].tmpapu_nro+'</h6>';
                cadena += '<h6 class="m-0 font-14">APU Nº '+resp.data[i].tmpapu_nro+'</h6>';
                cadena += "</div>";
                cadena +='<div class="col-6 col-md-6 alien-right">';
    ...
    const sendGetRequest = async () => {
        try {
            ...
            if (resp.data.success=='vacio') {
                ...
                table += '<h5 class="w-100">Sin informacion</h5>'
                table += '</td>';
                table += '</tr>';
            ...
            for (let i = 0; i < resp.data.length; i++) {
                ...
                total_itn = parseInt(parseInt(resp.data[i].cantidad_producto)*parseInt(resp.data[i].precio_producto));                table += '<tr>';
                table += '<td>';
                table += '<div class="product-name">';
                ...
                table += '<span class="h5" >'+resp.data[i].cantidad_producto+'</span>';
                ...
                table += '<td>';
                table +=`
                <div class="row option-editar" style="display: none;" id="${id_apu}form-editar-precio-product${i}">
                    ...
                    <div class="col-3 col-md-3 px-0 pt-1">
                        <div class="row">
                            <div class="col-6 col-md-6 w-30 px-0">                                        
                                <button class="btn-option-success mx-2"  onclick="imputPrecio_producto(${resp.data[i].id},${i},${id_apu},${data.id_categoria},${resp.data[i].id_producto});"  title="Editar"><i class="fa fa-check"></i></button>
                            </div>
                ...
                `;
                table +=`
                <div class="row option-edit-precio${i}"  >
                    <div class="col-8 col-md-10 iten-contenid" ><h5 id="precio_producto_detalle">$ ${resp.data[i].precio_producto.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</h5></div>
                ...
                table += '<td><h5 id="'+id_apu+'suma_generl_cat' + i + '" > $ '+total_itn.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</h5></td>';
                table += '</tr>';
            ...
            table += '</td>';
            table += '<td><h5 class="f-w-600 h5" >$ '+suma_gener.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+' </h5></td>';
            table += '</tr>';
...
function btnProductUpSum(cod,iditem,id_apu, id_cat){
    ...
    // console.log(total);
    $("#"+id_apu+"suma_generl_cat"+iditem).text(total.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
...
function totalizar(d) {
    $("#suma_generl").text(d.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
// console.log(i);
...
function traer_porcentaje_admin_emprevistos(s){
    ...
    const sendGetRequest = async () => {
        try {
            ...
            $("#resumen_administracion").text(resp.data.suma_porc_administracion.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            $("#resumen_utilidad_emprevisto").text(resp.data.suma_porc_utilidad_emprevisto.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            var resume_suma_general =resp.data.suma_porc_utilidad_emprevisto+resp.data.suma_porc_administracion+s;
            $("#suma_general_resumen").text(resume_suma_general.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
        } catch (err) {
            // Handle Error Here
            console.error(err);
        }
    ...
    const sendGetRequest = async () => {
        try {
            ...
            if (resp.data.Suma_Materiales.length=="") {
                ...
                $("#resumen_material_total").text(d.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            }else{
            ...
            if (resp.data.Suma_Materiales.length=="") {
                console.log("vacio");
                $("#resumen_equipo_herramienta").text(deh.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            }else{
            ...
            if (resp.data.Suma_Servicio.length=="") {
                console.log("vacio");
                $("#resumen_servicio").text(d_serv.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            }else{
            ...
            if (resp.data.Suma_Mano_Obras.length=="") {
                console.log("vacio");
                $("#resumen_mano_obra").text(d_mano_ob.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            }else{
            ...
            $("#resumen_administracion").text(resp.data.Suma_Administracion.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            $("#resumen_utilidad_emprevisto").text(resp.data.Suma_Emprevistos.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
...
function calculaPorcentajes_adminis(id_apu,porc,numero){
    ...
    $("#porc_administracion"+id_apu).text(value.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
    guardar_valor_porc_administracion(id_apu,value,1); 

    $("#sub_total_dos"+id_apu).text(sub_totaldos.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
...
function calculaPorcentajes_utilidad_emprev(id_apu,porc,numero){
    ...
    $("#porc_utilidad_emprevis"+id_apu).text(value.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
    guardar_valor_porc_administracion(id_apu,value,2);
     $("#sub_total_tres"+id_apu).text(sub_totaldos.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
     $("#sub_total_tres_g"+id_apu).text(sub_totaldos.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
        // get_sum_categorias_apu(id_apu,sub_totaldos);
...
function calcular_descuento(id_apu,porc,numero) {
    ...
    $("#total_descuent"+id_apu).text(value.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
    $("#total_general_desc"+id_apu).text(totals.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
...
function suma_all_detalle_producto(id_apu) {
    const sendGetRequest = async () => {
        ...
        console.log(porc_admin);
           ...
           $("#total_all"+id_apu).text(sob_total_tres.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
           ...
           cadena+=`
               <div class="card-body border">
                   <div class="row py-1">
                       ...
                       <div class="col-12 col-md-4 item-div">
                           <samp class="" id="sup_total">$ ${suma_total.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                       </div>
                   </div>`;
            cadena+=`
            ...
            cadena+='<input type="number" readonly min="0" value="'+resp.data.apu[0].tmpapu_porc_administrativo+'" onchange="calculaPorcentajes_adminis('+id_apu+',this.value,'+suma_total+')" onKeyUp="calculaPorcentajes_adminis('+id_apu+',this.value,'+suma_total+')" max="100" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">';

            cadena+=`     <span class="input-group-text gb-text-color"
                       ...
                       <div class="col-12 col-md-4 item-div">
                           <samp id="porc_administracion${id_apu}"> ${porc_admin.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                   ...
                   <div class="row py-1">
                       ...
                       <div class="col-12 col-md-4">
                           <samp id="sub_total_dos${id_apu}">${sob_total_dos.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}<samp>
                       </div>
                   </div>
                   <div class="row py-1 text-dark bg-light">
                       <div class="col-12 col-md-3 item-div">
                           ...
                           <div class="input-group input-group-sm ">
                           `;
                cadena+='<input type="number" readonly id="num_porcen_utilidad'+id_apu+'" min="0" value="'+resp.data.apu[0].tmpapu_utl_imprevisto+'"  onchange="calculaPorcentajes_utilidad_emprev('+id_apu+',this.value,'+sob_total_dos+')" onKeyUp="calculaPorcentajes_utilidad_emprev('+id_apu+',this.value,'+sob_total_dos+')" max="100" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">';
                cadena+=`   <span class="input-group-text gb-text-color"
                                   id="inputGroup-sizing-sm">%</span>
                           </div>
                       </div>
                       ...
                       <div class="col-12 col-md-4 item-div">
                           <samp id="porc_utilidad_emprevis${id_apu}">${porc_utld_emp.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                       </div>
                   </div>
                   <div class="row py-1">
                       <div class="col-12 col-md-8 item-div">
                       ...
                       <div class="col-12 col-md-4 item-div">
                           <samp id="sub_total_tres${id_apu}">${sob_total_tres.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                       </div>
                   </div>
                   <div class="row  py-1 text-dark bg-light ">
                       <div class="col-12 col-md-8 item-div">
                       ...
                       <div class="col-12 col-md-4 item-div">
                       <input type="hidden" id="total_general_apu${id_apu}" value="${sob_total_tres}"> <samp class="h5" id="sub_total_tres_g${id_apu}">${sob_total_tres.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                       </div>
                   </div>
                   <div class="row py-1">
                       <div class="col-12 col-md-5 item-div">
                       ...
                       <div class="col-12 col-md-3 item-div">
                           <div class="input-group input-group-sm ">
                        `;
                    cadena+='<input type="number" min="0" readonly id="descuent'+id_apu+'" value="'+resp.data.apu[0].tmpapu_descuento+'"  onchange="calcular_descuento('+id_apu+',this.value,'+sob_total_tres+')" onKeyUp="calcular_descuento('+id_apu+',this.value,'+sob_total_tres+')"  max="100" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">';
                     cadena+=`<span class="input-group-text gb-text-color"
                                   id="inputGroup-sizing-sm">%</span>
                           </div>
                       </div>
                       <div class="col-12 col-md-4 item-div">
                           <samp id="total_descuent${id_apu}">${descuen.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                       </div>
                   </div>
                   <div class="row my-2">
                       <div class="col-12 col-md-8 item-div">
                       ...
                       <div class="col-12 col-md-4 item-div">
                           <samp class="h6" id="total_general_desc${id_apu}">${total_con_descuen.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')}</samp>
                       </div>
                   </div>
               </div>`;
           $("#box-sum-apu"+id_apu).html(cadena);
           $("#sup_total").text(suma_total.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
        //    console.log(suma_total);
               ...
               for (let i = 0; i < resp.data.length; i++) {
                ...
                total_iten= resp.data[i].cantidad*resp.data[i].tmpapu_suma_general; 
                    ...
                    cadena += '<div class="col-12 col-md-6 text-center item-div">';
                     ...
                     cadena +='<span class="h6">' + resp.data[i].cantidad + '</span>'
                    ...
                    cadena += '<td> <span id="total_all'+resp.data[i].id+'"> $'+resp.data[i].tmpapu_suma_general.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</span></td>';
                    cadena += '<td>';
                    cadena += '<span id="total_apuinten'+resp.data[i].id+'"> $'+total_iten.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</span>'; 
                    cadena += '</td>'; 
                    cadena += '</tr>'
                ...
                cadena += "</td>";
                cadena += '<td><input type="hidden" id="suma_general_all_apu_impu" value="'+sumg+'"><span id="suma_general_all_apu">$'+sumg.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</span></td>';
                cadena += '</tr>';
                cadena +='</tbody>';
                cadena +='</table>'; 
...
$("#select_producte,#select_product,#select_unidad").select2();  
