...
function list_apus(id) {
        ...
        try {
            ...
            if (resp.data.vacio) {
                ...
                for (let i = 0; i < resp.data.apus.length; i++) {
                    ...
                    table +='<td>';
                    table +='<div >'+resp.data.apus[i].tmpapu_suma_general.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</div>';
                    table +='</td>';
                    table +='<td>';
                    table +='<div >'+precio_tota.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</div>';
                    table +='</td>';
                    ...
                    table +='<td>';
                    table +=' <button class="btn-option-damger "  title="Anular facturas"><i class="fa fa-trash-o"></i></button>';
                    table +='</td>';
                    table +=' </tr>';
    ...
    //------------------------------------------------------tabla de partidas ------------------------------------------------------   
        ...
        //---------------------------------------------------------------end tabla de partidas---------------------------------------------------------------
                ...
                //     }else{
                //         // console.log(resp.data.file_cotizacion[i]);
...
function cal_descuento(e) {
    ...
    $('#valor_descuento').text("$"+desc_pre.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
    $('#valor_descuento_factura').val(desc_pre);

    let total2=parseFloat(total)-parseFloat(desc_pre);
    $('#sub_total2').text("$"+total2.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
...
function cal_iva(e) {
    ...
    $('#valor_iva').text("$"+iva.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
    $('#valor_iva_factura').val(iva);
    $('#total_general_factur').text("$"+total_general.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
...
function moneda_usd(mond) {
    ...
    input.addEventListener('keyup', e =>{
        ...
        $('#sub_total2').text("$"+valor_usd.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
        $('#sub_total2_inmpu').val(valor_usd);
        $('#total_general_factur').text("$"+valor_usd.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
...
function moneda_comp(mond) {
    ...
    // input.addEventListener('keyup', e =>{
        ...
        $('#sub_total1').text("$"+parseFloat(total).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'))
...
$("#update_factura").on("click", function (e) {
    const data={
      id_factura: $('#id_facturas').val(),
      metodo_pago: $('#metodo_pago').val(),
      type_moneda : $('#type_moneda').val(),
      trm_valor :$('#trm_valor').val(),
